function lead_dbs_register_normalize(directory, earoot, dbdir, slicerDir, connectomeDir, elmodel)

% - Lead-DBS Job created on 06-Dec-2021 15:23:55 -
% --------------------------------------

lead path;
options = getoptslocal;

options.uipatdirs = {directory};
options.earoot=earoot;
options.prefs.genetics.dbdir=dbdir;
options.prefs.slicer.dir=slicerDir;
options.prefs.lc.datadir=connectomeDir;

elModelKey=struct('BostonScientificVerciseDirected', 'Boston Scientific Vercise Directed', ...
                'StJudeDirected6173long', 'St. Jude Directed 6173 (long)', ...
                'BostonScientificVercise', 'Boston Scientific Vercise', ...
                'Medtronic3387', 'Medtronic 3387');

options.elmodel=elModelKey.(elmodel);
...
options.normalize.method = 'ea_normalize_spmshoot';
